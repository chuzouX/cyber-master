...
pub fn render(
    ...
    if detail_view {
        ...
        render_list(frame, content_area, hint_area, theme, challenges, selected, focused);
    }
}
...
mod tests {
    ...
    fn render_empty_list_no_panic() {
        ...
        terminal
            .draw(|f| render(f, f.area(), &theme, &[], 0, false, 0, true))
            .unwrap();
    }
    ...
    fn render_list_with_challenges() {
        ...
        let mut terminal = Terminal::new(TestBackend::new(42, 20)).unwrap();
        terminal
            .draw(|f| render(f, f.area(), &theme, &challenges, 0, false, 0, true))
            .unwrap();
    }
    ...
    fn render_detail_view() {
        ...
        terminal
            .draw(|f| render(f, f.area(), &theme, &[c], 0, true, 0, true))
            .unwrap();
    }
}
